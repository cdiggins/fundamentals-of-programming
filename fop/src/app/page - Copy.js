...
<Button variant="contained" href="#contained-buttons">
  Link
      ...
      <CodeMirror value={value} className="flex-1 p-4" height="400px" extensions={[javascript({ jsx: true })]} onChange={onChange} />     
      <div classname="flex flex-column flex-1">
      <canvas height="200px" className="flex-1 p4"></canvas>
